...
set_hitbox_value(atk, hbox_num, HG_WIDTH                    , 68);
...
set_hitbox_value(atk, hbox_num, HG_HITBOX_Y                 , -7);
...
set_hitbox_value(atk, hbox_num, HG_EXTRA_HITPAUSE          , 2);
