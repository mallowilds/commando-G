...
//set_hitbox_value(atk, hbox_num, HG_VISUAL_EFFECT            , fx_blast); // Spawn manually
set_hitbox_value(atk, hbox_num, HG_VISUAL_EFFECT_X_OFFSET   , 40);
set_hitbox_value(atk, hbox_num, HG_VISUAL_EFFECT_Y_OFFSET   , -36);
