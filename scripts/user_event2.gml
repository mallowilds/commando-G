...
// RTY -> Rarity
RTY_VISUAL = -6; // for visual-only items; mostly spent husks
...
// Chest properties
CHEST_AWAIT_TIME = 100;
CHEST_SMALL_TIME = 500;
CHEST_LARGE_TIME = 120;
CHEST_LARGE_TIME_EXT1 = 240; // CAC, not repositioning
CHEST_LARGE_TIME_EXT2 = 300; // CAC, repositioning
...
// DSpecial moved to be near probability things
...
SPARK_WARN_TIME = 180;
SPARK_ASPEED_SCALE = 3;
SPARK_SPEED_SCALE = 2;
SPARK_BUFF_DURATION = 420;
SPARK_MULTIHIT_DAMAGE_SCALE = 2;
SPARK_LAUNCHER_DAMAGE_SCALE = 6;
...
FILIAL_BUFFSPAWN_FRAMES = 601; // should be a prime
